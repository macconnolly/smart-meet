...
class ONNXEncoder:
    ...
    def _load_model(self) -> None:
        ...
        self._session = ort.InferenceSession(
            str(model_path), sess_options=sess_options, providers=self.config.providers
        )
    ...
    def _load_config(self) -> None:
        ...
        if not config_path.exists():
            ...
            self._model_config = {"embedding_dimension": 384, "max_seq_length": 256}
    ...
    def encode(
        self, sentences: Union[str, List[str]], normalize: bool = True, use_cache: bool = True
    ) -> np.ndarray:
        """
